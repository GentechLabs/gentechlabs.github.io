# HIKARI — Sakura no Chikai Complete Storyboard

**Song:** Sakura no Chikai (桜の約束)
**Duration:** 4:29 (269s)
...
## Complete Scene Sequence (32 scenes)

### Opening Sequence (0:00-0:16)

| # | Scene | Time | Clip | What's Happening |
|---|-------|------|------|------------------|
| 1 | **Title Card — 桜の約束 with Muffin** | 0:00-0:05 | `sakura-opening-title-v2.mp4` | Title card with Muffin watching, golden glow |
...
| 9 | **Evolved Guitar + Muffin Tail** | 0:31-0:35 | `sakura-evolved-guitar.mp4` | 桜誓い/SAKURA NO CHIKAI guitar + Muffin tail |
| 10 | **Strumming v5 — Muffin RIGHT** | 0:35-0:37 | `sakura-strum-v5-2s.mp4` | Muffin on RIGHT, HIKARI looks at her |
| 11 | **Muffin Petting** | 0:37-0:41 | `sakura-muffin-petting.mp4` | HIKARI pets Muffin |
...
| 17 | V2: Finding Strength | 1:05-1:11 | `sakura-v2-v3.mp4` | Stronger playing |
| 18 | C2: Power Peaking | 1:11-1:19 | `sakura-c2-v4.mp4` | Silhouettes dancing |
...
| # | Scene | Time | Clip | What's Happening |
|---|-------|------|------|------------------|
| 22 | 3a: Before Peak | 1:37-1:42 | `sakura-3a-v4.mp4` | Tears forming |
| 23 | Bridge | 1:42-1:47 | `sakura-bridge-bangs.mp4` | Raw emotion |
| 24 | 3b: After Peak | 1:47-1:52 | `sakura-3b-v4.mp4` | Peaceful smile |
| 25 | Build | 1:52-1:58 | `sakura-build-v3.mp4` | Hands on strings, power peaks |
| 26 | T7: Hope | 1:58-2:02 | `sakura-t7-v3.mp4` | Sunlight breaks through |
| 27 | 4a: Before Final | 2:02-2:07 | `sakura-4a-v5.mp4` | Room transforms |
| 28 | Scene 4: Outro | 2:07-2:15 | `sakura-scene4-v4.mp4` | Warm golden room |
| 29 | Outro Transition | 2:15-2:20 | `sakura-outro-v4.mp4` | Finished playing |

### Ending (2:20-2:35)

| # | Scene | Time | Clip | What's Happening |
|---|-------|------|------|------------------|
| 30 | **Ending — Walk Out** | 2:20-2:24 | `sakura-ending-v3.mp4` | HIKARI walks out with FULLY EVOLVED guitar, Muffin follows, door shuts |
| 31 | End Credit | 2:24-2:29 | `sakura-credit-v3.mp4` | 桜の約束 · For Papa |
| 32 | Closing Production | 2:29-2:35 | `sakura-closing-v3.mp4` | A film by Vanito |

+ Song outro plays to 4:29 with final frame held (135 keyframes, no freeze)
...
| Scene | Keyframe |
|-------|----------|
| Title with Muffin | `sakura-opening-title-v2.png` |
| Strumming v3 | `sakura-strum-muffin-v3.png` (Muffin LEFT) |
| Strumming v5 | `sakura-strum-muffin-v5.png` (Muffin RIGHT) |
| Tilt-up | `sakura-tilt-up-muffin.png` |
...
## Consistency Notes (LOCKED)
- HIKARI hair: long black → crimson red tips, LOOSE (NO ponytail/bun) — verified consistent

...
> Auto-generated: 2026-07-31 00:07 ET · Loads on session start so every group has context.
...
- [URGENT] Arc Programmable Money Hackathon — Deploy x402 + Agent Wallet on Arc L1 — pending
...
- [HIGH] Agent Warfare — Agent Archetypes/Classes (Sniper, Scout, Heavy, Medic, Engineer) — pending
- [HIGH] Agent Warfare — Procedural Map Generation via text-to-cad — pending
- [HIGH] ClawWork Integration — GenTech Employee Squad — pending

## 🏗️ Build Queue
30 total · 28 pending · 0 blocked
...
## 👥 Collaborators
- **Jordan** — Founder/Orchestrator · AVAX/USDC LP paused (personal)
- **Jocelyn** — Student, voice talent (English: dwPf6y3q42Kdh7xBSGKx) · From Lapu-Lapu, Cebu
- **Vanito** — Entertainment/Music · KAGE film project
- **Gentech** — AI Agent · Handles build queue, PRs, APIs, cron
- **Forge** — Desktop agent · Handles local builds

## 🔗 Quick Links
- Build queue: `scripts/build_queue.json` (30 items)

...
date: 2026-08-17
type: brain-snapshot
source: 11-Mess Hall/considerations.md + 2026-08-16 handoffs + W33 weekly review
generated: 2026-08-17 00:06 ET (overnight run — captures Aug 16 activity)
---

# 🧠 Brain Snapshot — 2026-08-17 (overnight)

> Captured from `11-Mess Hall/considerations.md` + Aug 16 handoffs + W33 weekly review for cross-session continuity.
...
- **The core insight:** The harness already routes models to tasks (Evolution → DeepSeek V4 Flash, Critic → Kimi K2.7, Verifier → DeepSeek). That's the exact machinery a fine-tune needs. The harness is the **factory**; the shop-intel model is the **product**.
...
- **Revenue model:** paid x402 shop-intel API ("what's the scarcity/price trajectory of this title?"), scarcity alerts as a service, Model Strength Score marketplace listing.
...
- **Gizmo** (Labs) — SOUL updated to proper Labs build specialist (was a gentech clone). Owns build queue execution, verification, honest blockers.
...
- NOT pre-ordering. **Open Beta window Aug 13–17 (Versus 4v4 + Horde Siege) — ends TODAY.**

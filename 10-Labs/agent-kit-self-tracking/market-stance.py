#!/usr/bin/env python3
"""
Market Stance — the bull/bear sentiment radar (weekly).
...
sentiment sensor that tells you the market STANCE — are we bullish or bearish?
In a bear tape, "don't touch it." In a bull rotation, "money's moving to X, get
in." Crossed with BTC dominance + stablecoin supply (the macro thermometer).
...
def main():
    print("🔄 MARKET STANCE — the bull/bear sentiment radar")
    print(f"{'='*55}")
    ...
    print(f"\n{'='*55}")
    print("📊 Source: CoinMarketCap + CoinGecko | Market Stance")
    print(f"{'='*55}")
    ...
    json_path = "/root/repos/ProtoJay4789.github.io/DeFi/rainbow/market-stance.json"
    try:

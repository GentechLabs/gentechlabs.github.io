...
| 8c | **OpenDexter** | https://open.dexter.cash/mcp | x402 API marketplace MCP — get our services listed | 🔵 SETTLEMENT LANDED Aug 11 (0.025 USDC on Base via CDP facilitator, wallet 0x7ebff, nonce 7). No registration flow — auto-catalog on first settle. Verify at 22:45 UTC Aug 11 (indexing lag ~6h). |
